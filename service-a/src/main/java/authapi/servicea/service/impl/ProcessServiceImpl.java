...
public class ProcessServiceImpl implements ProcessService {
    ...
    public ProcessResponseDto processText(ProcessRequestDto requestDto, String email) {
        ...
        HttpEntity<ProcessRequestDto> requestDtoHttpEntity
                = new HttpEntity<>(requestDto, httpHeaders);
        ResponseEntity<ProcessResponseDto> responseDtoResponseEntity
                = restTemplate.postForEntity(
                "http://data-api:8081/api/transform",
                requestDtoHttpEntity, ProcessResponseDto.class
        );
        ...
        if (!responseDtoResponseEntity.getStatusCode().is2xxSuccessful()
            ...
            throw new RuntimeException("Service B error: "
                    + responseDtoResponseEntity.getStatusCode());
        }
